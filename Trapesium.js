...
const Trapesium = ({ navigation }) => {
    ...
    const [sisi4, setSisi4] = useState('0');
            ...
            <ImageBackground source={imagebg} style={styles.image}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <TextInput
                            style={styles.input}
                            onChangeText={setSisi4}
                            placeholder="Sisi 4"
                            keyboardType="numeric"
                        />
                    </View>
                    <TouchableOpacity onPress={hitungKelilingTrapesium}>
                        <Text style={styles.button}>
                            Hitung Keliling Trapesium
                        </Text>
                    </TouchableOpacity>
                    <Text style={styles.hasil}>
                        Keliling Trapesium adalah {keliling} cm
                    </Text>
                </View>
